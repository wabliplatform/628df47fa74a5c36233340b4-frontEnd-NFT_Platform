  ...
  [...advanceSelect.querySelectorAll("[annotationname]")].forEach(
    ...
    tableData.forEach((data,index) => {
      ...
      const attributeSubdocumentElement = tableDataElement[
        index
      ].querySelector("[annotationname = 'titleNFT']");
      if (attributeSubdocumentElement !== null) {
        attributeSubdocumentElement.value = tableData[tableData.length - index -1].titleNFT;
      }
    }
    catch(e) {console.log(e);}; try {
      const attributeSubdocumentElement = tableDataElement[
      ...
      if (attributeSubdocumentElement !== null) {
        attributeSubdocumentElement.value = tableData[tableData.length - index -1].NFTCategory;
      }
    }
    catch(e) {console.log(e);}; try {
      const attributeSubdocumentElement = tableDataElement[
        index
      ].querySelector("[annotationname = 'NFTprice']");
      if (attributeSubdocumentElement !== null) {
        attributeSubdocumentElement.value = tableData[tableData.length - index -1].NFTprice;
      }
    }
    catch(e) {console.log(e);}; try {
      const attributeSubdocumentElement = tableDataElement[
      ...
      if (attributeSubdocumentElement !== null) {
        attributeSubdocumentElement.value = tableData[tableData.length - index -1].NFTdescription;
      }
    }
